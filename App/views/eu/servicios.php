  ...
  <body>
    ...
    <section class="section--compact">
      ...
      <article class="art15">
        ...
        <div>
          <a href="/eu/kontaktua" class="item" title="Plataforma anitzeko programazioari buruz hitz egin">
          ...
          <a href="/eu/kontaktua" class="item" title="SEO posizionamendu zerbitzuari buruz hitz egin">
          ...
          <a href="/eu/kontaktua" class="item" title="Data-ERP irtenbideei buruz hitz egin">
            <h4>Data-ERP</h4>
